...
* Students should complete the [Zoo Loop Activity](Activities/05-ZooLoop).
* Students should complete the [Rock-Paper-Scissors Activity](Activities/09-RPS-Coded).
...
* Students should be given a substantial amount of time to complete the rock-paper-scissors activity. They will not have been given everything they need to complete the activity. The idea is for students to become more comfortable with the idea of working without knowing _everything_. Reveal bits of the solution using the code in the [09-RPS-Coded](Activities/09-RPS-Coded) directory while students are working. Throughout class, show these bits of the solution on the projector, and try to help guide students through the problem.

* Have your TAs reference [3.2-TimeTracker](3.2-TimeTracker.xlsx) to help keep track of time during class. Your instructor NEEDS to leave enough time for students to complete the rock-paper-scissors game.
...
* Give them a few minutes to examine it, and immediately have a few students explain it to the class.
  ...
  * **File**
    ...
    * [`js-dissect-unsolved.html`](Activities/01-JSDissect/js-dissect-unsolved.html)
...
* After you go over the activity, if there are still questions, Slack out the fully commented file [`js-dissect-solved.html`](Activities/01-JSDissect/js-dissect-solved.html).
...
* Read the instructions aloud, and call on students to help you live-code the activity.
  ...
  * **File**
    ...
    * [`array-logs-unsolved.html`](Activities/02-CoolPeopleArray/array-logs-unsolved.html)
...
* Slack out [`array-logs-solved.html`](Activities/02-CoolPeopleArray/array-logs-solved.html) when finished.
...
* Read the instructions aloud, and call on students to help you live-code the activity.
  ...
  * **File**
    ...
    * [`array-setting-unsolved.html`](Activities/03-ArraySetting/array-setting-unsolved.html)
...
* Slack out [`array-setting-solved.html`](Activities/03-ArraySetting/array-setting-solved.html) when finished.
...
* Slack out the file and the instructions below.
  ...
  * **File**
    ...
    * [`my-first-loop.html`](Activities/04-MyFirstLoop/my-first-loop.html)
...
* Slack out the file and the instructions below.
  ...
  * **File**
    ...
    * [`zoo-loop-unsolved.html`](Activities/05-ZooLoop/zoo-loop-unsolved.html)
...
* Review [`zoo-loop-solved.html`](Activities/05-ZooLoop/zoo-loop-solved.html).
...
* Review [`another-loop-solved.html`](Activities/06-AnotherLoop/another-loop-solved.html).
...
* Then Slack out [`another-loop-solved.html`](Activities/06-AnotherLoop/another-loop-solved.html).
...
* Review [`hard-loop.html`](Activities/07-HardLoop/hard-loop.html).
...
* Open [`events-examples.html`](Activities/11-Events/events-examples.html).
...
*This short snippet demonstrates most of the concepts students will need for the RPS activity.*
```

### 18. Instructor Do: Demo RPS (2 mins)

* Take a couple of minutes to demonstrate the final application ([09-RPS-Coded](Activities/09-RPS-Coded)).
...
* **Instructor Note:** When time is up, show [`pseudocode-rps.html`](Activities/08-PseudoCode/pseudocode-rps.html).
...
* Slack out the following files and instructions to students.
  ...
  * **File**:
    ...
    * [`rps-2.html`](Activities/09-RPS-Coded/rps-2.html)
...
* Open [`rps-9.html`](Activities/09-RPS-Coded/rps-9.html), and walk students through the solution. Use the comments in the solution to help guide the conversation.
...
* If there is time still left over, complete the recap activity with students as a class [10-Recap](Activities/10-Recap).
